            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="<?= base_url('/create_user/save/'); ?>" method="POST" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" value="<?= isset($form_data['email']) ? $form_data['email'] : ""; ?>" class="form-control <?= (isset($errors['email']) ? 'is-invalid' : ''); ?>" name="email" id="email" autofocus />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="<?= isset($form_data['nama']) ? $form_data['nama'] : ""; ?>" class="form-control <?= (isset($errors['nama']) ? 'is-invalid' : ''); ?>" name="nama" id="nama" />
                                        <div class="invalid-feedback">
